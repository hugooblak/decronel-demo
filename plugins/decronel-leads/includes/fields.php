...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'decronel-leads' ),
				'storm'       => __( 'Storm or hail damage', 'decronel-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'decronel-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'decronel-leads' ),
				'not-sure'    => __( 'Vet inte än', 'decronel-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'decronel-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'decronel-leads' ),
				'research' => __( 'Jag kollar bara priser', 'decronel-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'decronel-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'decronel-leads' ),
		'contacted' => __( 'Kontaktad', 'decronel-leads' ),
		'quoted'    => __( 'Quote sent', 'decronel-leads' ),
		'won'       => __( 'Won', 'decronel-leads' ),
		'lost'      => __( 'Lost', 'decronel-leads' ),
		'spam'      => __( 'Misstänkt spam', 'decronel-leads' ),
	);
}
